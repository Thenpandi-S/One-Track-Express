<style>
 ...
 .a{
    ...
    .sq{
     ...
     .sqw{
      margin-left:155px;font-size:16px;color:yellow;
    }
      .sqe{
      margin-left:167px;font-size:16px;color:yellow;
    }
       .sqr{
      margin-left:190px;font-size:16px;color:yellow;
    }
       .sqt{
      margin-left:148px;font-size:16px;color:yellow;
    }
       .sqy{
      margin-left:177px;font-size:16px;color:yellow;
    }
        .squ{
      margin-left:150px;font-size:16px;color:yellow;
    }
          .sqi{
      margin-left:162px;font-size:16px;color:yellow;
    }
    .sqo{
...
<div class="c">
  ...
  <h4 class="nq"><b>Location</b> <b class="sqw">:</b><b class="kl"> <?php  echo $view_['location'] ; ?></b> </h4>
  <h4 class="nq"><b>Weight</b> <b class="sqe">:</b><b class="kl"> <?php  echo $view_['weight'] ; ?></b> </h4>
  <h4 class="nq"><b>Unit</b> <b class="sqr">:</b><b class="kl"> <?php  echo $view_['unit'] ; ?></b> </h4>
  <h4 class="nq"><b>Shipments</b><b class="sqt">:</b><b class="kl"> <?php  echo $view_['shipment'] ; ?></b> </h4>
</div>
