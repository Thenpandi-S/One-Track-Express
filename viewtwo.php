...
<div class="c">
  ...
  <h4 class="nq"><b>Company Name</b> <b class="sqw">:</b><b class="kl"> <?php  echo $view_['cname'] ; ?></b> </h4>
  <h4 class="nq"><b>Email</b> <b class="sqe">:</b><b class="kl"> <?php  echo $view_['email'] ; ?></b> </h4>
  <h4 class="nq"><b>Number</b> <b class="sqr">:</b><b class="kl"> <?php  echo $view_['number'] ; ?></b> </h4>
