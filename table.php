...
<tr>
    ...
    <th class="siz" >Location</th>
    <th class="siz" >Weight</th>
    <th class="siz" >Unit</th>
    <th class="siz" >Shipment</th>
...
<tr>
  ...
  <td><?php echo $all['weight'] ?></td>
  <td><?php echo $all['unit'] ?></td>
  <td><?php echo $all['shipment'] ?></td>
  
    <td><a class="an" href="delete.php?delete=<?php echo $all['ID'] ?>"><i class="fa-solid fa-trash" style="color: #e30202;"></i></a></td>
   <td><a class="ann" href="edit.php?edit=<?php echo $all['ID'] ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
  <td><a class="ans" href="view.php?view=<?php echo $all['ID'] ?>"><i class="fa-regular fa-eye"></i></a></td>
