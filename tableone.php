...
<tr>
    ...
    <th class="siz" >Company Name</th>
    <th class="siz" >Email</th>
    <th class="siz" >Phone Number</th>
...
<tr>
  ...
  <td><?php echo $all['cname'] ?></td>
  <td><?php echo $all['email'] ?></td>
  <td><?php echo $all['number'] ?></td>
  <td><?php echo $all['message'] ?></td>
  
    <td><a class="an" href="deletetwo.php?delete=<?php echo $all['ID'] ?>"><i class="fa-solid fa-trash" style="color: #e30202;"></i></a></td>
   <td><a class="ann" href="edittwo.php?edit=<?php echo $all['ID'] ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
  <td><a class="ans" href="viewtwo.php?view=<?php echo $all['ID'] ?>"><i class="fa-regular fa-eye"></i></a></td>
